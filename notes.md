>"You will use JavaScript to complete the Markdown to HTML 
...
> Here's a table containing all the markdown that convertMarkdown should be 
>
> able to handle and the expected HTML after conversion:
